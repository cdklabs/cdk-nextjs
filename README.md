...
1. $0.00 - if you're Next.js app does not need to access the internet, remove the NAT Gateway. Trade-off: less functionality.
2. $6.05 - managing your own [NAT Instance](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_NAT_Instance.html). See [examples/low-cost](./examples/low-cost/) for how to use [fck-nat](https://fck-nat.dev/stable/). Trade-off: less reliable.
3. $32.40 - use 1 AZ instead of 2. Trade-off: less reliable.
